...
#define GREEN_LED_2_PIN     D8
#define RED_LED_2_PIN       D7
...
uint8_t drv_gpio_get_state_pin(gpio_name_t pin)
{
	...
	switch(pin)
	{
        ...
        case GPIO_BUTTON_2:
            state = digitalRead(BUTTON_2_PIN); 
            break;

        case GPIO_GREEN_LED_2:
            state = digitalRead(GREEN_LED_2_PIN);
            break;
            
        case GPIO_RED_LED_2:
            state = digitalRead(RED_LED_2_PIN);
            break;
...
void drv_gpio_toggle_pin(gpio_name_t pin)
{
    switch(pin)
    {
        ...
        case GPIO_GREEN_LED_2:
            digitalWrite(GREEN_LED_2_PIN, !digitalRead(GREEN_LED_2_PIN));
            break;
        case GPIO_RED_LED_2:
            digitalWrite(RED_LED_2_PIN, !digitalRead(RED_LED_2_PIN));
            break;
